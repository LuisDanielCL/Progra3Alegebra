 ...
 * @author LuisDanielCL
 */
public class AddMatrizGaussSeidel extends javax.swing.JFrame {

    /**
     * Creates new form AddMatriz
     */
    MetodoGaussSeidel vMadre = new MetodoGaussSeidel();
    int filas, columnas, numMatriz;
    JTextField [][] valores = new JTextField[5][5];
    public AddMatrizGaussSeidel(int pFilas, int pColumnas, MetodoGaussSeidel pMadre) throws Exception {
        vMadre = pMadre;
